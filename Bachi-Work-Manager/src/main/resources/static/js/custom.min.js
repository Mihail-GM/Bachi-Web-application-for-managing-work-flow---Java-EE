    ...
    if ("undefined" != typeof echarts) {
        ...
        if ($("#mainb").length) {
            var b = echarts.init(document.getElementById("mainb"), a);
			 var showtextNew =  message1;
			  
            b.setOption({
                title: {
                    text: "Графика на задача",
                    subtext: "изработено по задача"
                },
                tooltip: {
                    trigger: "axis"
                },
                legend: {
                    data: ["завършена%", "отделени часове"]
                },
                toolbox: {
                    show: !1
                },
