...
(function(h) {
    ...
    function Ta(a, b, c) {
        var d = a._iDisplayStart,
            e = a._iDisplayLength,
            f = a.fnRecordsDisplay();
        0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "първа" == b ? d = 0 :
            "Назад" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "Напред" == b ? d + e < f && (d += e) : "Последна" == b ? d = Math.floor((f - 1) / e) * e : L(a, 0, "Unknown paging action: " + b, 5);
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Покажи _MENU_ записи",
            sLoadingRecords: "Зареждане...",
            sProcessing: "Обработване...",
            sSearch: "Търси",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Няма открити резултати"
        },
    ...
    h.extend(Mb, {
        ...
        full: function() {
            return ["първа", "Назад", "Напред", "Последна"]
        },
        ...
        simple_numbers: function(a, b) {
            return ["Назад", ya(a, b), "Напред"]
        },
        full_numbers: function(a, b) {
            return ["първа", "Назад", ya(a, b), "Напред", "Последна"]
        },
        _numbers: ya,
        numbers_length: 7
    });
